...
\begin{subfigure}[t]{0.9\textwidth}
	\centering
    \includegraphics[width=140mm]{lim-stanza}
    \caption{N-grams for the first line of a limerick}
    \label{fig:lim-grams1}
\end{subfigure}
\begin{subfigure}[t]{0.9\textwidth}
	\centering
    \includegraphics[width=140mm]{lim-lines}
    \caption{Animation of nouns in limericks}
    \label{fig:lim-anim}
\end{subfigure}
\begin{subfigure}[t]{0.9\textwidth}
	\centering
    \includegraphics[width=140mm]{lim-types}
    \caption{Animation of nouns in limericks}
    \label{fig:lim-types}
\end{subfigure}
...
\begin{subfigure}[t]{0.5\textwidth}
	\centering
    \includegraphics[width=70mm]{lim-stress1}
    \caption{Line 1}
    \label{fig:lim-stress1}
\end{subfigure}
\begin{subfigure}[t]{0.5\textwidth}
	\centering
    \includegraphics[width=70mm]{lim-stress2}
    \caption{Line 2}
    \label{fig:lim-stress2}
\end{subfigure}
\begin{subfigure}[t]{0.9\textwidth}
	\centering
    \includegraphics[width=70mm]{lim-stress5}
    \caption{Line 5}
...
\begin{subfigure}[t]{0.5\textwidth}
	\centering
    \includegraphics[width=70mm]{lim-stress3}
    \caption{Line 3}
    \label{fig:lim-stress3}
\end{subfigure}
\begin{subfigure}[t]{0.5\textwidth}
	\centering
    \includegraphics[width=70mm]{lim-stress4}
    \caption{Line 4}
...
\begin{subfigure}[t]{0.5\textwidth}
	\centering
    \includegraphics[width=70mm]{lim-tense}
    \caption{Probability distribution of overall poem tense}
    \label{fig:lim-tense}
\end{subfigure}
\begin{subfigure}[t]{0.5\textwidth}
	\centering
    \includegraphics[width=70mm]{lim-persp}
...
\begin{subfigure}[t]{0.9\textwidth}
	\centering
    \includegraphics[width=140mm]{haik-types}
    \caption{Animation of nouns in haiku}
    \label{fig:haik-types}
\end{subfigure}
\begin{subfigure}[t]{0.9\textwidth}
	\centering
    \includegraphics[width=140mm]{haik-lines}
    \caption{Animation of nouns in haiku}
    \label{fig:haik-anim}
\end{subfigure}
...
\begin{subfigure}[t]{0.5\textwidth}
	\centering
    \includegraphics[width=70mm]{haik-tense}
    \caption{Probability distribution of overall poem tense}
    \label{fig:haik-tense}
\end{subfigure}
\begin{subfigure}[t]{0.5\textwidth}
	\centering
    \includegraphics[width=70mm]{haik-persp}
    \caption{Probability distribution perspective across poem}
...
\begin{subfigure}[t]{0.5\textwidth}
	\centering
    \includegraphics[width=70mm]{son-tense}
    \caption{Probability distribution of overall poem tense}
    \label{fig:son-tense}
\end{subfigure}
\begin{subfigure}[t]{0.5\textwidth}
	\centering
    \includegraphics[width=70mm]{son-persp}
    \caption{Probability distribution perspective across poem}
    \label{fig:son-persp}
\end{subfigure}
\caption{Stress patterns for lines 3 and 4}
...
\begin{figure}[H]
\centering
\includegraphics[width=140mm]{son-simile}
\caption{Words used in sonnets with significant frequency}
